...
func exprlexerLexerInit() {
	...
	staticData.SymbolicNames = []string{
		"", "", "", "INT", "ADD", "SUB", "MULTIPLY", "DIVIDE", "WS",
	}
	staticData.RuleNames = []string{
		"T__0", "T__1", "INT", "ADD", "SUB", "MULTIPLY", "DIVIDE", "WS",
	}
	staticData.PredictionContextCache = antlr.NewPredictionContextCache()
	staticData.serializedATN = []int32{
		4, 0, 8, 41, 6, -1, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2,
		4, 7, 4, 2, 5, 7, 5, 2, 6, 7, 6, 2, 7, 7, 7, 1, 0, 1, 0, 1, 1, 1, 1, 1,
		2, 4, 2, 23, 8, 2, 11, 2, 12, 2, 24, 1, 3, 1, 3, 1, 4, 1, 4, 1, 5, 1, 5,
		1, 6, 1, 6, 1, 7, 4, 7, 36, 8, 7, 11, 7, 12, 7, 37, 1, 7, 1, 7, 0, 0, 8,
		...
		5, 22, 1, 0, 0, 0, 7, 26, 1, 0, 0, 0, 9, 28, 1, 0, 0, 0, 11, 30, 1, 0,
		0, 0, 13, 32, 1, 0, 0, 0, 15, 35, 1, 0, 0, 0, 17, 18, 5, 40, 0, 0, 18,
		2, 1, 0, 0, 0, 19, 20, 5, 41, 0, 0, 20, 4, 1, 0, 0, 0, 21, 23, 7, 0, 0,
		0, 22, 21, 1, 0, 0, 0, 23, 24, 1, 0, 0, 0, 24, 22, 1, 0, 0, 0, 24, 25,
		1, 0, 0, 0, 25, 6, 1, 0, 0, 0, 26, 27, 5, 43, 0, 0, 27, 8, 1, 0, 0, 0,
		28, 29, 5, 45, 0, 0, 29, 10, 1, 0, 0, 0, 30, 31, 5, 42, 0, 0, 31, 12, 1,
		0, 0, 0, 32, 33, 5, 47, 0, 0, 33, 14, 1, 0, 0, 0, 34, 36, 7, 1, 0, 0, 35,
		34, 1, 0, 0, 0, 36, 37, 1, 0, 0, 0, 37, 35, 1, 0, 0, 0, 37, 38, 1, 0, 0,
		0, 38, 39, 1, 0, 0, 0, 39, 40, 6, 7, 0, 0, 40, 16, 1, 0, 0, 0, 3, 0, 24,
		37, 1, 6, 0, 0,
	}
